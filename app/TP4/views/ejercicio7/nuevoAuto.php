    ...
    <div class="container card-container d-flex justify-content-center align-items-center" style="height: 80vh">
        <div class="card text-center bg-dark text-light" style="width: 38rem;">
            <div class="card-header">
                <h3>Cargar un nuevo Auto</h3>
                <p>Ingrese los datos del Auto:</p>
            </div>
            <div class="card-body">
                <form name="ejercicio7" method="post" action="action.php" class="row g-3 needs-validation" novalidate>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" pattern="([a-zA-Z]{1,20})" id="Marca" name="Marca" placeholder="Marca..." required>
                        <div class="invalid-feedback">
                            Ingrese una Marca...
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" pattern="([0-9]{1,4})" maxlength="11" id="Modelo" name="Modelo" placeholder="Modelo..." required>
                        <div class="invalid-feedback">
                            Ingrese un Modelo...
                        </div>
                    </div>
