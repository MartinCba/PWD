...
<body>
    ...
    function mensaje($cadenaDatos)
    {
        ...
        $deportes = $cadenaDatos['deportes'];
        $msj = "Nombre: " . $nombre . "</br>Apellido: " . $apellido . "</br>Edad: " . $edad . "</br>" . $mensajeEdad . "</br>" . $deportes;
        return $msj;
    }

    $datos = dataSubmitted();
    $obj = new Deportes();
    $cadenaDatos = $obj->mostrarDeportes($datos);
    $msj = mensaje($cadenaDatos);
